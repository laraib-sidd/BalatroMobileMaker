BalatroMobile Maker v1.0.2 - Interactive Edition
==========================
...
FEATURES:
--------
✓ Interactive mode - just double-click and answer questions!
...
✓ Guided setup with yes/no prompts for FPS, mods, and settings

CHANGELOG:
----------
v1.0.2 - Interactive mode! Double-click to run, guided setup with prompts
